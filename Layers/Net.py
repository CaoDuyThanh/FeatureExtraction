...
class ConvNeuralNet(NeuralNet):
    def __init__(self):
        ...
        # Default options for unpooling layers
        self.layer_opts['unpool_filter_size'] = (2, 2)
        ...
        # Default options for transposed conv layers
        self.layer_opts['trans_conv2D_input_shape']  = None
        self.layer_opts['trans_conv2D_filter_shape'] = (32, 3, 3, 3)
        self.layer_opts['trans_conv2D_W']            = None
        self.layer_opts['trans_conv2D_WName']        = ''
        self.layer_opts['trans_conv2D_b']            = None
        self.layer_opts['trans_conv2D_bName']        = ''
        self.layer_opts['trans_conv2D_border_mode']  = 'valid'
        self.layer_opts['trans_conv2D_stride']       = (1, 1)
        self.layer_opts['trans_conv2D_filter_flip']  = False
        self.layer_opts['trans_conv2D_filter_dilation'] = (1, 1)
