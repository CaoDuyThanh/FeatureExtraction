...
class SubplotManager():
    ...
    def _reset_extent(self,
                      _img):
        _data_shape = _img.shape
        _ax = self.fig_data.get_axes()

        self.fig_data.set_extent((-0.5, _data_shape[1] - .5, _data_shape[0] - .5, -.5))
        _ax.set_xlim((-0.5, _data_shape[1] - .5))
        _ax.set_ylim((_data_shape[0] - .5, -0.5))
...
class PlotManager():
    ...
    def save_main_plot(self,
                       _path):
        self.main_figure.savefig(_path)
